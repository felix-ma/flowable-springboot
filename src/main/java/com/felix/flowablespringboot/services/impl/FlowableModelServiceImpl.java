//package com.felix.flowablespringboot.services.impl;
//
//import com.fasterxml.jackson.databind.ObjectMapper;
//import com.fasterxml.jackson.databind.node.ObjectNode;
//import com.felix.flowablespringboot.services.IFlowableModelService;
...
//            }
//        } else {
//            returnVo = "Invalid file name, only .bpmn and .bpmn20.xml files are supported not " + fileName;
//        }
//        return returnVo;
//    }
//
//    private String createModel(InputStream inputStream) {
//        String returnVo = "创建模板成功";
//        try {
...
//                return "模板验证失败，原因: " + es.toString();
//            }
//            String fileName = bpmnModel.getMainProcess().getName();
//            if (CollectionUtils.isEmpty(bpmnModel.getProcesses())) {
//                return "No process found in definition " + fileName;
//            }
...
//            returnVo = "Import failed for , error message " + e.getMessage();
//        }
//        return returnVo;
//    }
//}
